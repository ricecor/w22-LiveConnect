...
class ChoosePollViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
  ...
  deinit{
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        pollTable.register(UINib(nibName: "PollingTableViewCell", bundle: nil), forCellReuseIdentifier: "PollCell")
...
//    }
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    let cell = tableView.dequeueReusableCell(withIdentifier: "PollCell", for: indexPath) as! PollingTableViewCell
